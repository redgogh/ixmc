...
#define sci_println_vector2(vec)                                                                                  \
         do {                                                                                                     \
                printf("[ %f        %f ]\n", vec[0], vec[1]);                                                     \
         } while(0)

#define sci_println_vector3(vec)                                                                                  \
         do {                                                                                                     \
                printf("[ %f        %f        %f ]\n", vec[0], vec[1], vec[2]);                                   \
         } while(0)                                                                                     
...
#define sci_println_matrix2(mat)                                                                                  \
        do {                                                                                                      \
            for (int i = 0; i < 3; i++)                                                                           \
                printf("| %f        %f |\n", mat[i][0], mat[i][1]);                                               \
        } while (0)

#define sci_println_matrix3(mat)                                                                                  \
        do {                                                                                                      \
            for (int i = 0; i < 3; i++)                                                                           \
                printf("| %f        %f        %f |\n", mat[i][0], mat[i][1], mat[i][2]);                          \
        } while (0)

#define sci_println_matrix4(mat)                                                                                  \
        do {                                                                                                      \
            for (int i = 0; i < 4; i++)                                                                           \
